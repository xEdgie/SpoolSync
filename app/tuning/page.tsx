      ...
      <div className="container mx-auto p-6 max-w-4xl">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              The requested tuning guide could not be found.
            </CardDescription>
          </CardHeader>
        </Card>
      </div>
        ...
        {currentGuide.steps.map((step: any, index: number) => (
          <Card key={step.step} className="overflow-hidden">
            <CardHeader>
              ...
              <CardDescription className="mt-6 text-muted-foreground">
                {step.description}
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              {step.select === "filament" && (
                <div className="space-y-2">
                  <Label htmlFor={`step-${step.step}-filament`}>
                    Select Filament
                  </Label>
                  <Select
                    ...
                    <SelectContent>
                      {filaments.map((filament) => (
                        <SelectItem key={filament.id} value={filament.id}>
                          {filament.printerName} - {filament.brand} -{" "}
